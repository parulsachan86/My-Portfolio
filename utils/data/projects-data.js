export const projectsData = [
  ...
  {
    id: 2,
    name: "Healthcare Consent Management System",
    description:
      "Developed a secure Healthcare Consent Management System to enable patients to control access to their medical records, using React.js for the front-end and Spring Boot–based microservices for a scalable backend.",
    tools: [
      "React.js",
      "Spring Boot",
      "Microservices",
    ...
    keyFeatures: [
      ...
      "Integrated Eureka for dynamic service discovery and fault-tolerant inter-service communication.",
      "Built secure RESTful APIs to ensure seamless and controlled data exchange across services.",
    ],
    impact:
      "Enhanced patient control over data privacy and consent management while improving system scalability and maintainability through a microservices-based architecture.",
    Github: "",
    demo: "",
  },
];
